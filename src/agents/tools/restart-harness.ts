 ...
 * `mcp__<server>__<tool>`, i.e. `mcp__claudeclaw__restart_harness`.
 */
export const RESTART_HARNESS_SERVER_NAME = 'claudeclaw';
...
const TOOL_DESCRIPTION = [
  'Restart the claudeclaw harness (this very process).',
  '',
